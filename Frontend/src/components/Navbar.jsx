...
const Navbar = ({ setShowLogin }) => {
  ...
  return (
    <>
      <div className={`navbar ${isNavbarHidden ? 'navbar-hidden' : ''} ${isHomePage ? 'navbar-home' : ''}`}>
        <Link to="/">
        ...
        <div className="nav-right">
          ...
          {!token ? (
            ...
            <div className="navbar-profile">
              <img src={assets.profile_icon} alt="profile" onClick={toggleProfileDropdown} style={{ cursor: 'pointer' }} />
              <ul className={`profile-dropdown ${showProfileDropdown ? 'show' : ''}`}>
